...
class EntertainmentTab extends StatefulWidget {
  ...
  @override
  _EntertainmentTabState createState() => _EntertainmentTabState();
}

class _EntertainmentTabState extends State<EntertainmentTab> {
  List<NewsModel> newsList = new List<NewsModel>();
  bool _loading = false;
  String ctr = EntertainmentTab.country;
  ...
  getNews(String country) async {
    ...
    newsList = new List();
    String api_url =
        "https://newsapi.org/v2/top-headlines?country=$country&category=entertainment&apiKey=2b826ea9d85542a898f1ef683de48b71";
